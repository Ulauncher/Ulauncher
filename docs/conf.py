...
release = ulauncher.version
# The short X.Y version.
version = ".".join(ulauncher.version.split(".")[0:2])
...
htmlhelp_basename = "Ulauncherdoc"
...
latex_documents = [
    (master_doc, "Ulauncher.tex", "Ulauncher Documentation", author, "manual"),
]
...
man_pages = [(master_doc, "ulauncher", "Ulauncher Documentation", [author], 1)]
