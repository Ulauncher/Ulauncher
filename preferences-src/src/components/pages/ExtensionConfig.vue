  ...
  <div class="ext-config">
    <div class="header-info">
      ...
      <div class="ext-info">
        ...
        <div class="notes" >
          <span v-if="extension.is_preinstalled">preinstalled,</span>
          <span v-if="!extension.is_preinstalled">user installed,</span>
      ...
      <div class="menu">
        <b-dropdown
          ...
          :text="(!extension.is_enabled && 'Enable' || canSave && 'Save') || (canCheckUpdates && 'Check Updates') || (canRemove && 'Remove')"
        >
