...
from ulauncher.extension.server.ExtensionPreferences import ExtensionPreferences
...
class TestExtensionPreferences:
    ...
    def db(self, mocker):
        Db = mocker.patch('ulauncher.extension.server.ExtensionPreferences.KeyValueDb')
