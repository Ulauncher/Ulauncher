...
class TestExtensionMode:
    ...
    def ext_server(self, mocker: MockerFixture) -> Any:
        mocker.patch("ulauncher.modes.extensions.extension_mode.ExtensionRegistry")
    ...
    def test_handle_query__controller_handle_query__is_called(self) -> None:
        keyword = "asdf"
        ext_id = "com.test.ext"
        ...
        mode.ext_socket_server.handle_query.assert_called_with(ext_id, trigger_id, query)
