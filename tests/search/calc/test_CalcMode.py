...
class TestCalcMode:
    ...
    def test_is_enabled(self, mode):
        ...
        assert mode.is_enabled('sin(pi)')
        assert mode.is_enabled('sin(-pi/4)')
        assert mode.is_enabled('sin(r(30))')
        assert mode.is_enabled('log(34)')
        assert mode.is_enabled('log10(1+pi*10)')
