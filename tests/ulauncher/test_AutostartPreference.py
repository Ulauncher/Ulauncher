import os
import pytest
import ulauncher.AutostartPreference as ap
...
class TestAutostartPreference:
    ...
    def db(self, mocker, desktop_file):
        db = mocker.patch('ulauncher.AutostartPreference.db')
    ...
    def test_is_allowed__retuns_False(self, db):
        ...
        assert not ap.AutostartPreference().is_allowed()
    ...
    def test_switch__raises_when_not_allowed(self, autostart, mocker):
        ...
        with pytest.raises(ap.SwitchError):
    ...
    def test_switch__raises_SwitchError(self, autostart, mocker):
        desktop_parser = mocker.patch('ulauncher.AutostartPreference.DesktopParser').return_value
