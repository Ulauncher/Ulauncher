...
from ulauncher.helpers import singleton, parse_options
from ulauncher.config import EXTENSIONS_DIR, ULAUNCHER_APP_DIR
...
class ExtensionRunner(object):
    ...
    def __init__(self):
        ...
        self.dont_run_extensions = parse_options().no_extensions
        self.verbose = parse_options().verbose
