...
class ExtensionRegistry:
    ...
    def install_from_staging(
        ...
        """Finish an install whose repo is already in staging_dir, which the caller owns.

        The CLI downloads once so it can categorize before routing. This runs the extension
        half (deps, stop, swap, state) without downloading again.
        """
