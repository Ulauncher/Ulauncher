...
# Scratch dirs, kept out of scanned install roots so a partial download is never mistaken
# for an installed extension or theme. Under DATA so the post-install swap is a same filesystem rename.
