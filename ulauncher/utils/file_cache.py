...
) -> Callable[[Callable[Param, Ret]], Callable[Param, Ret]]:
    def decorator(func: Callable[Param, Ret]) -> Callable[Param, Ret]:
        ...
        @wraps(func)
        def wrapped(*args: Param.args, **kwargs: Param.kwargs) -> Ret:
